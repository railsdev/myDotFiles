...
if has("gui_running")
  ...
  if has("win32")
    ...
    " set guifont=Menlo\ for\ Powerline\ Bold\ 15 
...
command Combine execute "Dispatch DEPLOYMENT_TYPE=shared MS_RELEASE_LEVEL=development ruby /home/hardik/workspace/mangoapps/script/combine_static_scripts"
